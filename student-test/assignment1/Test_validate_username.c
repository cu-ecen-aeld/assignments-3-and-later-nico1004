...
void test_validate_my_username()
{
     ...
     */
	const char* user_name_hardcoded = my_username();
	const char* user_name_file = malloc_username_from_conf_file();

	TEST_ASSERT_EQUAL_STRING(user_name_hardcoded, user_name_file);
}
